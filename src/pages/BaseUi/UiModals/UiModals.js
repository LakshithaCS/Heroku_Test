...
import { Button, Card, CardBody, Col, Container, Input, Modal, ModalHeader, PopoverBody, PopoverHeader, Row, UncontrolledPopover, UncontrolledTooltip } from 'reactstrap';
        ...
        <React.Fragment>
            ...
            <Modal id="exampleModalFullscreenSm" isOpen={modal_fullscreen_sm} toggle={() => { tog_fullscreen_sm(); }} >
                <div className="modal-header">
                    ...
                    <Button type="button" className="btn-close" onClick={() => { setmodal_fullscreen_sm(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            <Modal id="exampleModalFullscreenMd" isOpen={modal_fullscreen_md} toggle={() => { tog_fullscreen_md(); }} >
                <div className="modal-header">
                    ...
                    <Button type="button" className="btn-close" onClick={() => { setmodal_fullscreen_md(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            <Modal id="exampleModalFullscreenLg" isOpen={modal_fullscreen_lg} toggle={() => { tog_fullscreen_lg(); }} >
                <div className="modal-header">
                    ...
                    <Button type="button" className="btn-close" onClick={() => { setmodal_fullscreen_lg(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            <Modal id="exampleModalFullscreenXl" isOpen={modal_fullscreen_xl} toggle={() => { tog_fullscreen_xl(); }} >
                <div className="modal-header">
                    ...
                    <Button type="button" className="btn-close" onClick={() => { setmodal_fullscreen_xl(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            <Modal id="exampleModalFullscreenXxl" isOpen={modal_fullscreen_xxl} toggle={() => { tog_fullscreen_xxl(); }} >
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalFullscreenXxlLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_fullscreen_xxl(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h6 className="fs-15">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            <Modal id="fadeInRightModal" isOpen={modal_animationRight} toggle={() => { tog_animationRight(); }} modalClassName="fadeInRight" centered >
                <div className="modal-header">
                    <h5 className="modal-title" id="fadeInRightModalLabel" > Modal Heading </h5>
                    <Button className="btn-close" onClick={() => { setmodal_animationRight(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="fadeInleftModal" isOpen={modal_animationLeft} toggle={() => { tog_animationLeft(); }} modalClassName="fadeInLeft" centered >
                <div className="modal-header">
                    <h5 className="modal-title" id="fadeInleftModalLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_animationLeft(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="fadeInUpModal" isOpen={modal_animationUp} toggle={() => { tog_animationUp(); }} modalClassName="fadeInUp" centered >
                <div className="modal-header">
                    <h5 className="modal-title" id="fadeInUpModalLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_animationUp(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="flipModal" isOpen={modal_animationFlip} toggle={() => { tog_animationFlip(); }} modalClassName="flip" centered >
                <div className="modal-header">
                    <h5 className="modal-title" id="flipModalLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_animationFlip(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="flipModal" isOpen={modal_animationZoom} toggle={() => { tog_animationZoom(); }} modalClassName="zoomIn" centered >
                <div className="modal-header">
                    <h5 className="modal-title" id="flipModalLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_animationZoom(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body">
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="topmodal" isOpen={modal_positionTop} toggle={() => { tog_positionTop(); }} >
                <div className="modal-header">
                    <h5 className="modal-title" id="myModalLabel" > Modal Heading </h5>
            ...
            <Modal id="bottomModal" isOpen={modal_positionBottom} toggle={() => { tog_positionBottom(); }} className="modal-dialog-bottom" >
                <div className="modal-header">
                    <h5 className="modal-title" id="myModalLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_positionBottom(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body text-center p-5">
                    <lord-icon src="https://cdn.lordicon.com/pithnlch.json"
                        trigger="loop" colors="primary:#121331,secondary:#08a88a" style={{ width: "120px", height: "120px" }}>
            ...
            <Modal id="bottom-rightModal" isOpen={modal_positionBottomRight} toggle={() => { tog_positionBottomRight(); }} className="modal-dialog-bottom-right" >
                <div className="modal-header">
                    <h5 className="modal-title" id="myModalLabel" > Modal Heading </h5>
                    <Button type="button" className="btn-close" onClick={() => { setmodal_positionBottomRight(false); }} aria-label="Close"> </Button>
                </div>
                <div className="modal-body text-center p-5">
                    <lord-icon src="https://cdn.lordicon.com/pithnlch.json"
                        trigger="loop" colors="primary:#121331,secondary:#08a88a" style={{ width: "120px", height: "120px" }}>
