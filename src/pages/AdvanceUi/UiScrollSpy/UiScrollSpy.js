...
import { Card, CardBody, Col, Container, DropdownItem, Nav,DropdownMenu, DropdownToggle, NavLink, Row, UncontrolledDropdown } from 'reactstrap';
...
import { NavbarExample, NestedNavExample, ListgroupExample } from './UiScrollSpyCode';
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <MetaTags>
                    <title>ScrollSpy | Velzon - React Admin & Dashboard Template</title>
                </MetaTags>
                <Container fluid>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>data-bs-spy="scroll"</code> attribute to update links in a navigation list based on the current scroll position. Scroll the area below the navbar and watch the active class
                                        change.</p>
                                    ...
                                    <div className="d-none code-view">
                                        <pre>
                                            <code className="language-markup" style={{ height: "275px" }}>
                                                <NavbarExample />
                                            </code>
                                        </pre>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>data-bs-spy="scroll"</code> attribute. Scrollspy also works with nested nav. If a nested nav is active, its parents will also be active. Scroll the area next to the navbar and watch the active class change.</p>
                                    <div className="live-preview">
                                        <Row className="gy-4">
                                            <Col xxl={3}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>data-bs-spy="scroll"</code> attribute. Scrollspy also works with the list-group. Scroll the area next to the list group and watch the active class change.</p>
                                    <div className="live-preview">
                                        <Row className="gy-4">
                                            <Col xxl={3}>
                                    ...
                                    <div className="d-none code-view">
                                        <pre>
                                            <code className="language-markup" style={{ height: "352px" }}>
                                                <ListgroupExample />
                                            </code>
                                        </pre>
                                    </div>
